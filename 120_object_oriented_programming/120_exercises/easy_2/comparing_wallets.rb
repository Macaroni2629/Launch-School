...
Any application that deals with passwords and password verification would likely benefit from using protected methods because the program would want to verify the password but not make them accessible outside of the object.