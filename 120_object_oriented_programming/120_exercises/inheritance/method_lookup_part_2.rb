...
# Here, Ruby searches for the #color method in every class and module in the search path. Since the method isn't anywhere, the answer includes every class and module in the search path.