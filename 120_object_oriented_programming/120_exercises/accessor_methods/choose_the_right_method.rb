...
# Discussion
# As discussed in the previous exercise, implementing getter and setter methods is so common in Ruby that there are built-in methods to help you do so.

# Previously, we used both #attr_writer and #attr_reader. Implementing both of these methods is common in Ruby classes. In fact, there's even a built in method to implement both methods at the same time named attr_accessor.
