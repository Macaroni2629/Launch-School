...
They are both pass by value, meaning, references to the actual objects are passed to the method, 
but the + operator method reassigns, while the << shovel method mutates.
=end