...
# Discussion
# This is a little tricky to get right with the indexing, but is actually fairly straightforward.

# If you examine the example matrix and the resulting example transpose matrix, you will see that what used to be the first column of the matrix becomes the first row of the result, what used to be the second column becomes the second row, and what used to be the third column becomes the third row. We use this insight to implement our method.
...
# The first p command demonstrates that the result matrix is correct, and the second p command confirms that the original matrix is unmodified.
