...
# Discussion
# This exercise takes a lot of time to explain, but is not that difficult to implement. Once you understand what is expected, it's simply a matter of setting up a processing loop, and doing the necessary processing.
...
# We use a case statement for the body of our loop. The one thing that might trip you up is remembering to put integer tokens into the register; an easy step to do, an easy step to forget.